...
# collision by Natalie Lunbeck, Changling Li and Brendan Martin
...
def credits():
    ...
    while running:
        ...
        label('Lead Programmers - Natalie Lunbeck, Changling Li and Matthew Maring', 400, 225, white, fontSmall)
